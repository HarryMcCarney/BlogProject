...
import { comparePrimitives, Lazy, disposeSafe, getEnumerator, defaultOf } from "../fable-library-js.4.19.3/Util.js";
import { empty, map as map_5, tryFind, add, toList } from "../fable-library-js.4.19.3/Map.js";
import { toString as toString_2 } from "../fable-library-js.4.19.3/BigInt.js";
import { toString as toString_3 } from "../fable-library-js.4.19.3/Date.js";
import { toString as toString_4 } from "../fable-library-js.4.19.3/TimeSpan.js";
import { map as map_1 } from "../fable-library-js.4.19.3/List.js";
import { defaultArg, map as map_2, defaultArgWith, some } from "../fable-library-js.4.19.3/Option.js";
import { toString as toString_5, FSharpRef } from "../fable-library-js.4.19.3/Types.js";
import { class_type, getGenerics, getGenericTypeDefinition, getTupleFields, getTupleElements, isTuple, isGenericType, getEnumUnderlyingType, isEnum, getElementType, isArray, getUnionCaseFields, getUnionFields, isUnion, getRecordElements, getRecordField, name, isRecord, fullName as fullName_1 } from "../fable-library-js.4.19.3/Reflection.js";
import { item, setItem, fill, map as map_3 } from "../fable-library-js.4.19.3/Array.js";
import { Util_CachedEncoders, Util_Cache$1__GetOrAdd_43981464, CaseStrategy, Util_Casing_convert } from "./Types.fs.js";
import { mapIndexed, map as map_4, fold } from "../fable-library-js.4.19.3/Seq.js";
