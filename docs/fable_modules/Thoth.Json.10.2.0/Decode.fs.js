import { toFail, printf, toText, join } from "../fable-library-js.4.19.3/String.js";
import { Result_Bind, Result_Map, FSharpResult$2 } from "../fable-library-js.4.19.3/Result.js";
...
import { toString as toString_12, FSharpRef } from "../fable-library-js.4.19.3/Types.js";
import { tryParse as tryParse_3 } from "../fable-library-js.4.19.3/Int32.js";
import { parse, fromInt32, toUInt64, fromFloat64, toInt64, toFloat64 } from "../fable-library-js.4.19.3/BigInt.js";
import { tryParse as tryParse_4 } from "../fable-library-js.4.19.3/Long.js";
import { tryParse as tryParse_5 } from "../fable-library-js.4.19.3/Decimal.js";
import Decimal from "../fable-library-js.4.19.3/Decimal.js";
import { toUniversalTime, tryParse as tryParse_6, minValue } from "../fable-library-js.4.19.3/Date.js";
import { tryParse as tryParse_7, minValue as minValue_1 } from "../fable-library-js.4.19.3/DateOffset.js";
import { tryParse as tryParse_8 } from "../fable-library-js.4.19.3/TimeSpan.js";
import { map as map_4, defaultArg, some } from "../fable-library-js.4.19.3/Option.js";
import { ofArray, toArray, map as map_1, length, singleton, append as append_1, tail as tail_1, head as head_1, isEmpty, ofSeq, empty, reverse, fold, tryLast, cons } from "../fable-library-js.4.19.3/List.js";
import { int16ToString, numberHash, compare, comparePrimitives, uncurry3, defaultOf, uncurry2, int32ToString } from "../fable-library-js.4.19.3/Util.js";
import { map as map_2, tryFind, foldBack, fill, setItem, fold as fold_1, item } from "../fable-library-js.4.19.3/Array.js";
import { contains, fold as fold_2, toList, append, reverse as reverse_1 } from "../fable-library-js.4.19.3/Seq.js";
import { getGenerics, getGenericTypeDefinition, makeTuple, getTupleElements, isTuple, isGenericType, parseEnum, getEnumValues, getEnumUnderlyingType, isEnum, getElementType, isArray, isUnion, makeRecord, getRecordElements, isRecord, fullName as fullName_1, makeUnion as makeUnion_1, getUnionCaseFields, getUnionCases, name as name_3, class_type } from "../fable-library-js.4.19.3/Reflection.js";
import { empty as empty_1, map as map_3, tryFind as tryFind_1, add, ofSeq as ofSeq_1, ofList } from "../fable-library-js.4.19.3/Map.js";
import { ofSeq as ofSeq_2 } from "../fable-library-js.4.19.3/Set.js";
