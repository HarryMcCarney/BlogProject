...
module MasterLayout =
    ...
    let render content =
        [ Html.html [ Attr.custom ("data-theme", "light") ]
          Html.head
              [
                ...
                Html.custom ("link", [ Attr.rel "stylesheet"; Attr.href "styles.css" ])

                Html.custom ("link", [ Attr.rel "preconnect"; Attr.href "https://fonts.googleapis.com" ])

                Html.custom ("link", [ Attr.rel "preconnect"; Attr.href "https://fonts.gstatic.com" ])

                Html.custom (
                    "link",
                    [ Attr.rel "stylesheet"
                      Attr.href
                          "https://fonts.googleapis.com/css2?family=Yrsa:ital,wght@0,300..700;1,300..700&display=swap" ]
                )
                ...
                Html.script [ Attr.src "Script.js"; Attr.type' "module" ]
          ...
          Html.body
              [ Attr.classes [ "has-background-light"; "has-text-dark" ]
                ...
                Html.section [ Attr.classes [ "container"; "is-fluid" ]; navbar; content; footer ] ] ]
        |> toString
