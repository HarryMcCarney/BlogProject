            ...
            [ Attr.classes [ "navbar"; "is-fluid"; "has-text-dark"; "has-background-light" ]
              ...
              Html.div
                  [ Attr.id "navbarBasicExample"
                    ...
                    Html.a [ Attr.classes [ "navbar-item" ]; Html.text "About"; Attr.href "about.html" ]

                    ] ]

    let customLinkStyle =
        Attr.style
            "color:#363636; text-decoration:underline; font-weight:bold; transition-duration:0.3s; transition-property:color; transition-timing-function:ease"

    let customLinkHoverStyle = Attr.style "color:#363636"
                    ...
                    Html.p
                        [ Fragment
                              [ Html.strong "Content"
                                ...
                                Html.a [ Attr.href "http://opensource.org/licenses/mit-license.php"; Html.text "MIT" ]
                                Html.ins
